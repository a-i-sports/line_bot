# This is a program for running the line_bot spiders
# Run from the line_bot directory with this command:
...
os.system('scrapy crawl line_spider -o items.jl')
